...
# Import des fichiers data necessaires
Paris_ref = load_data_csv('C:/Users/famil/Desktop/DataScientest/STREAMLIT/ParisDonneesSurfacePop.csv')
# https://drive.google.com/file/d/1koLrvUANp48fRO3jRZZJ2Z7AAvH1Eu8s/view?usp=drive_link

dfvelib_arrondissements = load_data_csv('C:/Users/famil/Desktop/DataScientest/STREAMLIT/velib_arrondissements.csv')
# https://drive.google.com/file/d/1Jnyw7KUM7q1JebWXBqsJWkxeGlJi9OLE/view?usp=drive_link
# fichier pas utiliser - a checker

@st.cache_data
def load_data_gpd(url):
    #st.write(f"Loading data from: {url}")
    data = gpd.read_file(url)
    return data

arrondissements = load_data_gpd("C:/Users/famil/Desktop/DataScientest/STREAMLIT/arrondissements.geojson")
# https://drive.google.com/file/d/1-Db20X7lBZVtJ-uMYY62gIdpqUaW42YG/view?usp=drive_link
...
def load_data_json(url):
    ...
    return data
dfvelib = load_data_json("C:/Users/famil/Desktop/DataScientest/STREAMLIT/VelibEmplacementDesStations.json")
# https://drive.google.com/file/d/1bzM7AOThOe6CEo_At_rljav7LkcKH9fj/view?usp=drive_link
